...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { anonimo: @comentario.anonimo, autor_id: @comentario.autor_id, contenido: @comentario.contenido, fecha: @comentario.fecha }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { anonimo: @comentario.anonimo, autor_id: @comentario.autor_id, contenido: @comentario.contenido, fecha: @comentario.fecha }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
